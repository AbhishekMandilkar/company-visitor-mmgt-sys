...
$count_total_visitors=mysqli_num_rows($query3);
 ?>                       
                                    ...
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                ...
                                                <span style="">Total Visitors </span>
                                            </div>
                                        </div>
                        ...
                        <?php
//Car parking slot
 $query4=mysqli_query($con,"select VehicleNO from tblparking");
$count_total_vehicle=mysqli_num_rows($query4);
 ?>                       
    
    <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c5" style="padding:0">
                                    <img src="images/parking.jpg" style="border-radius: 10px" alt="">
                                    <div class="overview__inner" style="position: absolute;top: 16px;left: 18px;">
                                        <div class="overview-box clearfix">
                                            
                                            <div class="text" >

                                                <span style="color:black">Total Vehicles parked: </span>
                                                <h2 style="color:black"><?php echo $count_total_vehicle?></h2>
